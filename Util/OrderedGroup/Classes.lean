...
/-! ### Some extra specialisations of CovariantClass lemmas in the
spirit of mul_le_mul_left', etc.  -/

section CovariantClassSpecialisations
...
end CovariantClassSpecialisations
