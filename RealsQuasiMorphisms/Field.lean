...
/-- A set with a lowerbound is wellfounded. -/
...
/-- An "inverse" for a positive AlmostHom. -/
...
/-- Inverse for any ubounded AlmostHom. -/
...
/-- Inverse f composed with f is a bounded AlmostHom. -/
